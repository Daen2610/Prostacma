...
import Clases.GeneradorCodigoBarras;
import Clases.GeneralFolio;
import static Clases.GeneralFolio.generarFolioBase;
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtFolios, javax.swing.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
                                    .addComponent(fecharetiro, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
...
private void cargarTablaAlmacen(String numeroParte) {
  ...
  private void cargarTablaRetiros(String numeroParte) {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
 // Obtener los valores de los campos
    String folio = txtFolios.getText().trim(); // Campo para ingresar el folio
    ...
    // Verificar si el folio existe en la tabla Almacen_Inv
    ...
    int confirmacion = JOptionPane.showConfirmDialog(
        this,
        "¿Estás seguro de que quieres retirar la pieza con folio " + folio + "?",
        "Confirmar retiro",
        JOptionPane.YES_NO_OPTION
    );

    // Si el usuario confirma, proceder con la retirada
    if (confirmacion == JOptionPane.YES_OPTION) {
        // Retirar la pieza usando el folio
        if (SeguimientoPiezas.retirarPiezaPorFolio(folio, new java.sql.Date(fechaSeleccionada.getTime()))) {
            JOptionPane.showMessageDialog(this, "Pieza retirada correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            limpiarCampos(); // Limpiar los campos después de un registro exitoso
        } else {
            JOptionPane.showMessageDialog(this, "Error al retirar la pieza.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    limpiarCampos();
